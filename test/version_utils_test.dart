...
void main() {
  group('VersionUtils Tests', () {
    test('cleanVersion correctly strips leading v and preserves build metadata as subversion', () {
      expect(VersionUtils.cleanVersion('v1.0.7'), '1.0.7');
      expect(VersionUtils.cleanVersion('V1.0.6.11'), '1.0.6.11');
      expect(VersionUtils.cleanVersion('1.0.6+11'), '1.0.6.11');
      expect(VersionUtils.cleanVersion('  v1.0.6.10+5  '), '1.0.6.10.5');
    });
    ...
    test('compareSemver handles 3-part and 4-part versions', () {
      ...
      // 1.0.6+10 < 1.0.6.11
      expect(VersionUtils.compareSemver('1.0.6+10', '1.0.6.11'), -1);
      expect(VersionUtils.compareSemver('1.0.6+11', '1.0.6.11'), 0);
    ...
    test('isUpdateAvailable correctly detects newer releases', () {
      ...
      expect(VersionUtils.isUpdateAvailable('1.0.6.11', '1.0.6.11'), isFalse);
      expect(VersionUtils.isUpdateAvailable('1.0.6+11', '1.0.6.11'), isFalse);
